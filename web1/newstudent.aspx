...
<body>
    ...
    <div style="font-weight: 700">
        ...
        <table class="auto-style1">
            <tr>
                <td colspan="5">
                    <asp:Label ID="Label1" runat="server" Text="NewStudent"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label3" runat="server" Text="Gendar"></asp:Label>
                </td>
                <td>
                    <asp:RadioButton ID="mail" runat="server" OnCheckedChanged="RadioButton1_CheckedChanged" />
                    <asp:RadioButton ID="Fmail" runat="server" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label7" runat="server" Text="Facalty"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label10" runat="server" Text="nathionality"></asp:Label>
                </td>
                <td>
